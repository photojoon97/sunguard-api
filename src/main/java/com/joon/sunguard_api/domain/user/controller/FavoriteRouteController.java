...
public class FavoriteRouteController {
    ...
    public ResponseEntity<FavoriteRouteResponse> registerFavoriteRoute(@AuthenticationPrincipal CustomOAuth2User user, @RequestBody FavoriteRouteRequest favoriteRoute) {

        FavoriteRouteResponse registeredRoute = favoriteRouteService.registerFavoriteRoute(user, favoriteRoute);
